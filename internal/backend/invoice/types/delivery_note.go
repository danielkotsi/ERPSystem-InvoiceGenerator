...
func (r *DeliveryNote) RecieptInvoiceLines(invoicetype string, invoicelines []*payload.InvoiceRow, summary *payload.InvoiceSummary, buyer *payload.Company, paymentmethods *payload.PaymentMethods) error {
	emptylines := 24
...
func (r *DeliveryNote) InvoiceLinePrices(line *payload.InvoiceRow, discount int) error {
...
func (r *DeliveryNote) AddIncomeClassificationInSummary(classificationItem *payload.ClassificationItem, summary *payload.InvoiceSummary) error {
...
func (r *DeliveryNote) CompletePaymentMethods(paymentmethods *payload.PaymentMethods, buyer *payload.Company, totalgrossamount float64) error {
